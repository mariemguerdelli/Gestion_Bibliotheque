...
public class Empreint extends JFrame implements ActionListener {
	...
	public Empreint() {
		...
		textFieldd.setBounds(163, 24, 141, 23);
		...
		textFieldd_1.setBounds(163, 62, 141, 23);
		panel_2.add(textFieldd_1);
		
		comboboxx.setModel(new DefaultComboBoxModel(new String[] {"","Visiteur"}));
		comboboxx.setForeground(Color.black);
		comboboxx.setBackground(new Color(34, 66, 124));
		comboboxx.setBounds(163, 92, 141, 23);
		...
		comboboxx1.setBounds(163, 128, 141, 23);
		...
		textFieldd_4.setBounds(163, 161, 141, 23);
		...
		textFieldd_5.setBounds(163, 197, 141, 23);
		...
		textFieldd_6.setBounds(163, 233, 141, 23);
		...
		btnEmprunt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql7 = "select titre  from document";
				...
				try {
					...
					while (rs.next()) {
						String titre1 = rs.getString("titre").toString();
					...
					else{ok=false;System.out.println("il existe paaaaaaaaaaaaaaaaaaaaaaaaaaaaas");break;}
				...
				String nom = textFieldd.getText().toString();
	       		...
	       		try {
                	...
                	pst3.close();
	       			...
	       			PreparedStatement ps = conn.prepareStatement("INSERT INTO `fiche_emprunt`(`nom`, `prenom`, `statut`,`type`, `titre`, `date_debut_pret`,`date_limite`) VALUES (?,?,?,?,?,?,?)");
