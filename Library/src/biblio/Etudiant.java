...
public class Etudiant extends JFrame implements  ActionListener {
	...
	private JButton button3 = new JButton("Modifier mes données");
    ...
    public Etudiant(){
    	setIconImage(Toolkit.getDefaultToolkit().getImage(Etudiant.class.getResource("/images/avatar.png")));
        ...
        text.setText("Bonjour cher Etudiant!");
        ...
        text1.setBounds(310, 100, 200, 36);
        pan.add(text1);
		...
		button.setBounds(490, 100, 150, 36);
		...
		pan.add(button);
		 ...
		 button1.setBounds(380, 340, 100, 36);
	...
	//button.addActionListener(this);
        ...
        pan.add(label1);
		 ...
		 button3.setBounds(490,340,170,36);
