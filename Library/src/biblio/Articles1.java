...
public class Articles1 extends JFrame implements ActionListener {
...
setContentPane(pan);
pan.setLayout(null);
this.setTitle("Articles_Etudiant");
...
text3.setText("NB: Vous pouvez emprunter au max 2 documents à la fois");
