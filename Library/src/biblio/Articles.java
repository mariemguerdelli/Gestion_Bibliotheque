...
public class Articles extends JFrame implements ActionListener {
	...
	private JButton button8 = new JButton("Cliquer ici pour consulter tous nos Articles");
	private Empreint E1;

		
public Articles(){
	setIconImage(Toolkit.getDefaultToolkit().getImage(Articles.class.getResource("/images/bib.png")));
...
setContentPane(pan);
pan.setLayout(null);
this.setTitle("Articles_Visiteur");
this.setSize(700, 500);
this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
this.setLocationRelativeTo(null);
	

text.setText("Nos Articles ");
...
text1.setText("Cliquer 'Recherche' pour chercher un article : ");
...
text2.setText("Nos Articles les plus empruntés : ");
...
text3.setText("NB: Vous pouvez emprunter 1 seul document");
...
button8.setBounds(20, 420, 300, 30);
...
public void actionPerformed(ActionEvent event) {
	...
	if(event.getSource()== btnSearch) {
		//String name = JOptionPane.showInputDialog("Entrez le nom d'article recherché");}
		this.dispose();
		 s1 = new Search();
		 setVisible(false);
        s1.setVisible(true);}
