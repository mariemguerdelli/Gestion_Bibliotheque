...
public class Magasines1 extends JFrame implements ActionListener {
...
setContentPane(pan);
pan.setLayout(null);
this.setTitle("Magasines_Etudiant");
...
text3.setText("NB: Vous pouvez emprunter au max 2 magasines à la fois");
