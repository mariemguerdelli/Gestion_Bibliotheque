...
public class Magasines extends JFrame implements ActionListener {
...
public Magasines(){
	setIconImage(Toolkit.getDefaultToolkit().getImage(Magasines.class.getResource("/images/bib.png")));
...
setContentPane(pan);
pan.setLayout(null);
this.setTitle("Magasines_Visiteur");
...
text3.setText("NB: Vous pouvez emprunter 1 seule magasine");
