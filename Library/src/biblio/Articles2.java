...
public class Articles2 extends JFrame implements ActionListener {
...
setContentPane(pan);
pan.setLayout(null);
this.setTitle("Articles_Enseignant");
...
text3.setText("NB: Vous pouvez emprunter au max 4 documents à la fois");
